...
//   const csrftoken = getCookie("csrftoken");
//   const URL = `/report/?categoria_reporte=${encodeURIComponent(categoria_reporte)}&tipo_reporte=${encodeURIComponent(tipo_reporte)}&data_type=${encodeURIComponent(dataType)}&page=${pageNumber}`;
// }